...
public enum ErrorCode {
	...
	RECOMMENDATION_EMBEDDING_FAILED(HttpStatus.INTERNAL_SERVER_ERROR, "RECOMMENDATION_003", "임베딩 생성에 실패했습니다."),
	RECOMMENDATION_EMPTY_EMBEDDING(HttpStatus.INTERNAL_SERVER_ERROR, "RECOMMENDATION_004", "생성된 임베딩 값이 비어 있습니다.");
