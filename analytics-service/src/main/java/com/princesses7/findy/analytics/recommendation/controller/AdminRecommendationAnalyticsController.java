...
public class AdminRecommendationAnalyticsController {
	...
	private static final String PROMOTION_RECOMMENDATION_TYPE = "PROMOTION";
	...
	public ApiResponse<RecommendationSelectionRateResponse> getAlternativeSelectionRateAnalytics(
		...
		return ApiResponse.ok("대체상품 선택률 분석 조회에 성공했습니다.", response);
	}
	...
	public ApiResponse<RecommendationSelectionRateResponse> getPromotionSelectionRateAnalytics(
		...
		return ApiResponse.ok("행사상품 선택률 분석 조회에 성공했습니다.", response);
	}
}